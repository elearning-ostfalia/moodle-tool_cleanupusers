...
$string['toarchivelink'] = 'Browse list of users to be archived';
$string['toarchiveby'] = 'Users who will be archived by \'{$a}\'';
$string['toarchive'] = 'Browse list of users to be archived';
$string['reactivate'] = 'Browse list of archived users';
$string['reactivateuser'] = 'Reactivate this user';
$string['achivedusers'] = 'Archived users';
$string['todelete2'] = 'Users to be deleted';
$string['todelete'] = 'Browse list of users to be deleted';
...
$string['deleteifneverloggedin'] = 'Action on suspend time if never logged in';
