 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 *
 * @covers \userstatus_timechecker\suspendedchecker::get_to_suspend()
 * @covers \userstatus_timechecker\suspendedchecker::get_to_reactivate()
 *
 */
...
//        set_config('suspendtime', 10, 'userstatus_timechecker');
        ...
        $this->checker = new \userstatus_timechecker\suspendedchecker();
    }
    ...
    protected function create_checker() {
        return new \userstatus_timechecker\suspendedchecker();
    }
