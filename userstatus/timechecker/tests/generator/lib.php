...
class userstatus_timechecker_generator extends testing_data_generator {
    ...
    public function test_create_preparation() {
        ...
        $DB->insert_record_raw('tool_cleanupusers', ['id' => $reactivate->id, 'archived' => true,
            'timestamp' => $dayago, 'checker' => 'timechecker'], true, false, true);
        ...
        $DB->insert_record_raw(
            'tool_cleanupusers',
            ['id' => $delete->id, 'archived' => true, 'timestamp' => $yearago, 'checker' => 'timechecker'],
            true,
            false,
            true
        );
        ...
        $DB->insert_record_raw(
            'tool_cleanupusers',
            ['id' => $notdelete1->id, 'archived' => true, 'timestamp' => $dayago, 'checker' => 'timechecker'],
            true,
            false,
            true
        );
        ...
        $DB->insert_record_raw(
            'tool_cleanupusers',
            ['id' => $notdelete2->id, 'archived' => true, 'timestamp' => $yearago, 'checker' => 'timechecker'],
            true,
            false,
            true
        );
